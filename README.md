...
| [spring-ai-showcase](spring-ai-showcase/) | Showcase mit sechs typischen LLM-Integrationsbereichen: REST-Chat, Prompt-Templates, RAG, Vektordatenbank (Qdrant), LangChain4j, KI-Business-Logik | Spring Boot, React, OpenAI API, Qdrant, LangChain4j |
...
| [spring-t23d-demo](spring-t23d-demo/) | Prompt-to-3D (T23D): Bauteil per Text beschreiben, LLM generiert FreeCAD-Python-Code, der isoliert in Docker ein 3D-Modell (STL) erzeugt und im Browser angezeigt wird | Spring Boot, React (react-three-fiber), OpenAI API, FreeCAD, Docker |
